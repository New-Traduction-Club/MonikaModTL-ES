...
translate spanish mm_choose_movie_c739ccaa:
    ...
    m "¿Qué película te gustaría ver?"

# game/zz_monikamovie.rpy:236
...
translate spanish mm_found_movie_1224f3c7:
    ...
    m 1hub "¡Prepárate para empezar la película, haré la cuenta atrás!"

# game/zz_monikamovie.rpy:244
translate spanish mm_movie_resume_1045306a:

    # m 1eua "Three...{w=1}{nw}"
    m 1eua "Tres...{w=1}{nw}"

# game/zz_monikamovie.rpy:245
translate spanish mm_movie_resume_eeb72b36:

    # m "Two...{w=1}{nw}"
    m "Dos...{w=1}{nw}"

# game/zz_monikamovie.rpy:246
translate spanish mm_movie_resume_35439b6c:

    # m "One...{w=1}{nw}"
    m "Uno...{w=1}{nw}"

# game/zz_monikamovie.rpy:263
translate spanish movie_loop_7b54c2d5:

    # m 1eua "Just ended for me! Did you like it?"
    m 1eua "¡Acaba de terminar para mí! ¿Te ha gustado?"

# game/zz_monikamovie.rpy:271
...
translate spanish mm_movie_repeattime_319eaa31:
    ...
    m 1eub "Dímelo en el formato HH:MM:SS, [player]."

# game/zz_monikamovie.rpy:321
translate spanish mm_movie_repeattime_29bc6b3a:

    # m 1lksdlc "Erm..."
    m 1lksdlc "Emm..."

# game/zz_monikamovie.rpy:322
...
translate spanish mm_movie_repeattime_159463d9:
    ...
    m 1eka "Recuerda ponerlo en el formato HH:MM:SS."

# game/zz_monikamovie.rpy:324
...
translate spanish mm_movie_repeattime_a0aef037:
    ...
    m "Aquí tienes un ejemplo, [player]."

# game/zz_monikamovie.rpy:326
translate spanish mm_movie_repeattime_ab28eb65:

    # m "01:05:32"
    m "01:05:32"

# game/zz_monikamovie.rpy:327
translate spanish mm_movie_repeattime_5f927a0c:

    # m 1eub "That's 1 hour, 5 minutes, and 32 seconds."
    m 1eub "Eso es 1 hora, 5 minutos y 32 segundos."

# game/zz_monikamovie.rpy:328
...
translate spanish strings:
    ...
    # game/zz_monikamovie.rpy:14
    old "I changed my mind"
    new "He cambiado de opinión"
