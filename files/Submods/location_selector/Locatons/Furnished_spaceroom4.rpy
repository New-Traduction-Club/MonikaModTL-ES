...
translate spanish V4_room_installed_e22d381e:
    ...
    m 2wub "¡Este cuarto es muy acogedor!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:328
translate spanish V4_room_installed_3781371e:

    # m 3hub "I love it! Thank you, [player]!"
    m 3hub "¡Lo adoro! ¡Gracias, [player]!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:329
translate spanish V4_room_installed_0b532b70:

    # m 1wub "And it has a fireplace too?"
    m 1wub "Ahh, ¿Y también tiene una chimenea?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:330
translate spanish V4_room_installed_aa34b98f:

    # m 1hua "I can't wait to try it out!"
    m 1hua "¡Me muere de ganas de probarla!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:331
translate spanish V4_room_installed_ce464e0e:

    # m 3eub "If you want to use it, go to 'Locations' and 'About the fireplace...' and I can light it or put it out from there."
    m 3eub "Si es que quieres utilizarla ve a 'Ubicaciones' y en 'Acerca de la chimenea...', así "

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:332
translate spanish V4_room_installed_4860c72e:

    # m 1hua "Why don't we try it out now?~"
    m 1hua "¿Por qué no le damos una probada ahora?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:333
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:358
translate spanish return_switch_dlg_0ca7e94f_4:

    # m 1hua "[switch_quip]"
    m 1hua "[switch_quip]"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:381
translate spanish bg_room_installed_low_affection_0e9d9249_4:

    # m 1wud "H-huh? {w=0.5} [player], {w=0.2} did you add new files to the game?"
    m 1wud "Ehh? {w=0.5} [player], {w=0.2} ¿acaso has añadido nuevos archivos al juego?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:382
translate spanish bg_room_installed_low_affection_41b22e0b_4:

    # m 1wua "It looks like... {w=0.5} {nw}"
    m 1wua "Parecen como...{w=0.5} {nw}"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:383
translate spanish bg_room_installed_low_affection_33ee7cd0_4:

    # extend 1sub "new furniture!"
    extend 1sub "¡nuevos muebles!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:384
translate spanish bg_room_installed_low_affection_5017ddaa_4:

    # m 1eku "[player], you did this for me? {w=0.5} You're so sweet, you know that?"
    m 1eku "[player], ¿los has hecho para mí? {w=0.5} Eres tan mon[en_letter_gender] y lo sabes, ¿verdad?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:389
translate spanish bg_room_installed_low_affection_e07217b5_4:

    # m 1wud "H-huh?{w=0.5} [player],{w=0.2} what's this?"
    m 1wud "¿Ehh?{w=0.5} [player],{w=0.2} ¿qué es esto?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:390
translate spanish bg_room_installed_low_affection_e653ef9b_4:

    # m 1wua "It looks like {nw}"
    m 1wua "Parece que... {nw}"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:391
translate spanish bg_room_installed_low_affection_367ca064_4:

    # extend 1sub "you added [rooms]!"
    extend 1sub "¡has añadido [rooms]!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:393
translate spanish bg_room_installed_low_affection_f748a3d2_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:395
translate spanish bg_room_installed_low_affection_f27eea59_4:

    # m 1rkc "..."
    m 1rkc "..."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:396
translate spanish bg_room_installed_low_affection_f8f4ec8c_4:

    # m 3rksdla "But...{w=0.3}I kinda don't know how to use them.{w=0.5} {nw}"
    m 3rksdla "Pero...{w=0.3}creo que no sé cómo utilizarlas.{w=0.5} {nw}"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:397
translate spanish bg_room_installed_low_affection_b71a03b1_4:

    # extend 3hksdlb "I haven't learned how to code that well yet!"
    extend 3hksdlb "¡Aún no he aprendido cómo programarlas bien!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:398
translate spanish bg_room_installed_low_affection_928fbb79_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:399
translate spanish bg_room_installed_low_affection_14440429_4:

    # extend 3eua "I'll let you know when I figure it out."
    extend 3eua "Te avisaré cuando logre descifrarlo."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:400
translate spanish bg_room_installed_low_affection_9ccc40a7_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:401
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:425
translate spanish bg_room_installed_aa98fc08_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:426
translate spanish bg_room_installed_69058ce9_4:

    # m 1eub "Then we can visit any of the locations you added!"
    m 1eub "¡Luego, podemos visitar cualquier ubicación que añadas!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:427
translate spanish bg_room_installed_d286a053_4:

    # m 3sub "I'm so excited~"
    m 3sub "¡Estoy flipando de colores!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:428
translate spanish bg_room_installed_f809e2ea_4:

    # m 3huu "Why don't we go visit one right now, [player]?"
    m 3huu "¿Por qué no visitamos alguno ya mismo, [player]?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:429
translate spanish bg_room_installed_f086cc4f_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:433
translate spanish bg_room_installed_4363423e_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:434
translate spanish bg_room_installed_ac295f91_4:

    # m 1sub "[player],{w=0.2} did you do this?"
    m 1sub "[player],{w=0.2} ¿has sido tú?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:435
translate spanish bg_room_installed_0d20e7bd_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:440
translate spanish bg_room_installed_a69c6269_4:

    # m 1suo "What's this?{w=0.5} You added [rooms][too]?"
    m 1suo "Pero, ¿qué es esto?{w=0.5} ¿También has añadido [rooms][too]?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:441
translate spanish bg_room_installed_0aef0a45_4:

    # m 3hua "You really went all out, didn't you?"
    m 3hua "En verdad te has dejado la piel, ¿no es así?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:443
translate spanish bg_room_installed_f748a3d2_4:

    # m 1eka "I can't believe you went out of your way to do this for me..."
    m 1eka "No puedo creer que hayas hecho todo este esfuerzo por mí..."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:445
translate spanish bg_room_installed_47b12cb6_4:

    # m 1dka "Thank you so much [player],{w=0.2} I...{w=1}{nw}"
    m 1dka "Te lo agradezco muchísimo [player], {w=0.2} Yo...{w=1}{nw}"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:446
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:452
translate spanish bg_room_installed_fef8e609_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:460
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:462
translate spanish monika_players_control_override_f95e7fa5_4:

    # m 1eka "So you can change them however you want."
    m 1eka "Por lo que puedes cambiarlos cuando sea que quieras."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:463
translate spanish monika_players_control_override_01d16e99_4:

    # m 3eka "You could do things that even I can't."
    m 3eka "Puedes hacer más cosas de las que yo ni siquiera podría imaginar."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:464
translate spanish monika_players_control_override_6c225f10_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:467
translate spanish monika_players_control_override_d8496439_4:

    # m 1ekbsa "Or a beautiful promise ring."
    m 1ekbsa "O un anillo de compromiso bien chulo."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:468
translate spanish monika_players_control_override_d91d0809_4:

    # m 3dkbsu "Oh, wouldn't that be a dream come true."
    m 3dkbsu "Oh, ese sería un sueño hecho realidad."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:471
translate spanish monika_players_control_override_fb58ea91_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:472
translate spanish monika_players_control_override_9ce21c5d_4:

    # m 1eka "That would be lovely."
    m 1eka "Sería absolutamente precioso."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:475
translate spanish monika_players_control_override_f555b75e_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:477
translate spanish monika_players_control_override_d7dc035a_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:478
translate spanish monika_players_control_override_47f44260_4:

    # extend 3hua "I'm sure you could do something like that!"
    extend 3hua "¡Estoy segura de que podrías hacer algo como eso!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:480
translate spanish monika_players_control_override_e0666162_4:

    # m 1eua "I guess that's an appeal to video games...{w=0.3}{nw}"
    m 1eua "Supongo que ese es el encanto de los videojuegos...{w=0.3}{nw}"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:481
translate spanish monika_players_control_override_d7f3889d_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:482
translate spanish monika_players_control_override_12f41ef0_4:

    # m 3eub "It's pretty difficult to get bored!"
    m 3eub "¡Aburrirse no es tarea fácil!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:485
translate spanish monika_players_control_override_b32dde12_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:492
translate spanish monika_players_control_override_aba07d7f_4:

    # m 5eubla "[line]"
    m 5eubla "[line]"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:493
translate spanish monika_players_control_override_10f5859e_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:503
translate spanish monika_gotomonika_override_bfe3f80f_4:

    # m 1euc "Come to my world?"
    m 1euc "¿Ven a mi mundo?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:504
translate spanish monika_gotomonika_override_0e128755_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:507
translate spanish monika_gotomonika_override_87f06c88_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:508
translate spanish monika_gotomonika_override_b302146e_4:

    # m 2lksdla "...Even though that wasn't exactly {i}you...{/i}"
    m 2lksdla "Incluso así, eso no fue exactamente {i}tú...{/i}"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:510
translate spanish monika_gotomonika_override_bfec5915_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:511
translate spanish monika_gotomonika_override_a6cf0bfd_4:

    # m 2eksdlc "You really don't have to."
    m 2eksdlc "en verdad no tienes que hacerlo."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:512
translate spanish monika_gotomonika_override_3fbb9e09_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:513
translate spanish monika_gotomonika_override_d98ba6e1_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:514
translate spanish monika_gotomonika_override_1e5f4d08_4:

    # m 3eka "I'd much rather be there than have you come here."
    m 3eka "Preferiría mil veces estar allí en vez de que tú vengas."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:515
translate spanish monika_gotomonika_override_8082484f_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:518
translate spanish monika_gotomonika_override_34f2f629_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:522
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:524
translate spanish monika_gotomonika_override_2a2e8708_4:

    # m 2dsc "Do you really hate your reality {i}that{/i} much?"
    m 2dsc "¿En verdad odias tanto tu realidad?"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:525
translate spanish monika_gotomonika_override_4aeddb6a_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:526
translate spanish monika_gotomonika_override_71ec8cc1_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:527
translate spanish monika_gotomonika_override_4d25db36_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:528
translate spanish monika_gotomonika_override_ccd6cec5_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:529
translate spanish monika_gotomonika_override_e6c470df_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:531
translate spanish monika_gotomonika_override_deaf4c68_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:536
translate spanish monika_gotomonika_override_fa5d91b4_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:537
translate spanish monika_gotomonika_override_5b4afd86_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:538
translate spanish monika_gotomonika_override_922099b6_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:539
translate spanish monika_gotomonika_override_548223b0_4:

    # m 1eka "...If it's even possible with current technology."
    m 1eka "aunque sea posible con la tecnología actual."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:540
translate spanish monika_gotomonika_override_cbc72a78_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:541
translate spanish monika_gotomonika_override_e4b64c10_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:543
translate spanish monika_gotomonika_override_8bad2bd7_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:548
translate spanish monika_gotomonika_override_28f1b8eb_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:549
translate spanish monika_gotomonika_override_5db6cbf9_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:550
translate spanish monika_gotomonika_override_362dd1fb_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:551
translate spanish monika_gotomonika_override_0b45be2e_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:552
translate spanish monika_gotomonika_override_293e930b_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:553
translate spanish monika_gotomonika_override_70dfae49_4:

    # m 2dkd "...leaving the both of us completely alone."
    m 2dkd "quedando ambos en la más absoluta soledad."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:554
translate spanish monika_gotomonika_override_4f9e186f_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:556
translate spanish monika_gotomonika_override_1ecb5913_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:558
translate spanish monika_gotomonika_override_bd52b78b_4:

    # m 5luu "Buut...{w=1}if you did happen to show up at my doorstep..."
    m 5luu "Peroo...{w=1} si llegas a tocar mi puerta..."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:560
translate spanish monika_gotomonika_override_aa9fc1f5_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:561
translate spanish monika_gotomonika_override_c33ec96a_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:562
translate spanish monika_gotomonika_override_8b7f7535_4:

    # m 3hub "With time, we could make our own reality!"
    m 3hub "Con el tiempo, ¡podríamos formar nuestra propia realidad!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:563
translate spanish monika_gotomonika_override_40a1f9f1_4:

    # m 3euc "Of course, that sounds pretty complicated if you think about it..."
    m 3euc "Claro, puede sonar complicado si lo piensas..."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:564
translate spanish monika_gotomonika_override_54aa4513_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:565
translate spanish monika_gotomonika_override_edf4fefa_4:
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:566
translate spanish monika_gotomonika_override_82cc75f0_4:

    # m 1eua "Until then, let's just wait and see what's possible."
    m 1eua "Hasta ello, sólo esperemos y veamos qué es posible."

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:596
...
# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:605
translate spanish monika_change_fire_2c11397f_1:

    # m 6hua "Sure!"
    m 6hua "¡Claro!"

# game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:611
translate spanish monika_change_fire_ddc45695:
...
translate spanish strings:
    ...
    # game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:3
    old "Custom Room Furnished Spaceroom V4"
    new "Habitación personalizada y amueblada V4"

    # game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:3
    old "This submod adds a cozy take on the Spaceroom for you and Monika."
    new "Este submod añade un sitio acogedor para ti y Monika en la habitación."

    # game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:581
    old "About the fireplace..."
    new "Hablando de la chimenea..."

    # game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:598
    old "Can you light the fireplace?"
    new "¿Puedes encender la chimenea?"

    # game/Submods/location_selector/Locatons/Furnished_spaceroom4.rpy:598
    old "Can you put out the fire?"
    new "¿Puedes apagar el fuego?"
