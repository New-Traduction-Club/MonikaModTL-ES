...
translate spanish ch30_noskip_1c8cde12:
    ...
    m 1ekc "No te estaré aburriendo, ¿no?"
...
translate spanish ch30_noskip_6c95bb65:
    ...
    m 1eua "Además, el tiempo ha dejado de existir, así que no te servirá de nada."
...
translate spanish strings:
    ...
    # game/script-ch30.rpy:23
    old "Unstable mode files in install on first session. This can cause issues.\nPlease reinstall the latest stable version of Monika After Story to ensure that there will be no data issues."
    new "Archivos del modo inestable instalados en la primera sesión. Esto puede causar errores.\nPor favor, reinstala la última versión estable de Monika After Story para asegurarte de que no haya problemas con los datos."

    # game/script-ch30.rpy:297
    old "his"
    new "su"
