...
translate spanish mas_consumables_generic_get_a644a99b:
    ...
    m 1eua "Espera un momento."

# game/zz_consumables.rpy:1426
translate spanish mas_consumables_generic_get_cd3329c1:

    # m 1hua "Back!{w=1.5}{nw}"
    m 1hua "¡He vuelto!{w=1.5}{nw}"

# game/zz_consumables.rpy:1429
translate spanish mas_consumables_generic_get_7a2f3a16:

    # m 1eua "Okay, what else should we do today?"
    m 1eua "Vale, ¿qué más deberíamos hacer hoy?"

# game/zz_consumables.rpy:1475
...
# game/zz_consumables.rpy:1531
translate spanish mas_consumables_generic_finish_having_7a2f3a16:

    # m 1eua "Okay, what else should we do today?"
    m 1eua "Vale, ¿qué más deberíamos hacer hoy?"

# game/zz_consumables.rpy:1543
...
# game/zz_consumables.rpy:1578
translate spanish mas_consumables_generic_finished_prepping_7a2f3a16:

    # m 1eua "Okay, what else should we do today?"
    m 1eua "Vale, ¿qué más deberíamos hacer hoy?"

# game/zz_consumables.rpy:1583
translate spanish mas_consumables_refill_explain_819b455e:

    # m 3rksdla "I'd duplicate what I have now...but when I tried before, it just wasn't the same..."
    m 3rksdla "Duplicaría lo que tengo ahora... pero cuando lo intenté antes, simplemente no era lo mismo..."

# game/zz_consumables.rpy:1584
translate spanish mas_consumables_refill_explain_ca2f1dde:

    # m 1eksdla "I guess I must be missing something because I just can't seem to replicate the taste."
    m 1eksdla "Supongo que me debe faltar algo porque no consigo replicar el sabor."

# game/zz_consumables.rpy:1586
...
translate spanish mas_consumables_generic_running_out_bf9fbe47:
    ...
    m 1euc "Por cierto, [player]..."

# game/zz_consumables.rpy:1620
...
translate spanish mas_consumables_generic_running_out_a2abda03:
    ...
    m 1eka "No te importaría traerme más, ¿verdad?"

# game/zz_consumables.rpy:1652
...
translate spanish mas_consumables_generic_critical_low_e5ac8747:
    ...
    m 3eka "¿Te importaría traerme más alguna vez?"

# game/zz_consumables.rpy:1659
translate spanish mas_consumables_generic_critical_low_43956acc:

    # m 1hua "Thanks~"
    m 1hua "Gracias."

# game/zz_consumables.rpy:1694
translate spanish mas_consumables_generic_queued_running_out_dlg_877d057c:

    # m 1esc "By the way, [player]..."
    m 1esc "Por cierto, [player]..."

# game/zz_consumables.rpy:1697
translate spanish mas_consumables_generic_queued_running_out_dlg_44e47c86:

    # m 3rksdla "I've been running out of a few things in here..."
    m 3rksdla "Me he estado quedando sin algunas cosas aquí..."

# game/zz_consumables.rpy:1698
translate spanish mas_consumables_generic_queued_running_out_dlg_e134897a:

    # m 3eua "So I hope you don't mind, but I left you a list of things in the characters folder."
    m 3eua "Así que espero que no te importe, pero te he dejado una lista de cosas en la carpeta de personajes."

# game/zz_consumables.rpy:1709
...
translate spanish mas_consumables_remove_thermos_8f907c3a:
    ...
    m 1eua "Voy a guardar este termo. Ahora vuelvo.{w=1}{nw}"

# game/zz_consumables.rpy:1732
translate spanish mas_consumables_remove_thermos_31f19431:

    # m 1eua "Give me a second [player], I'm going to put this thermos away."
    m 1eua "Dame un segundo [player], voy a guardar este termo."

# game/zz_consumables.rpy:1748
translate spanish mas_consumables_remove_thermos_cd3329c1:

    # m 1hua "Back!{w=1.5}{nw}"
    m 1hua "¡He vuelto!{w=1.5}{nw}"

# game/zz_consumables.rpy:1751
translate spanish mas_consumables_remove_thermos_7cb5ebd1:

    # m "Okay, what else should we do today?"
    m "Vale, ¿qué más deberíamos hacer hoy?"

# game/zz_consumables.rpy:1783
translate spanish mas_consumables_candycane_finish_having_bf1e38de:

    # m 1eua "I'm going to get some more candy canes."
    m 1eua "Voy a por más bastones de caramelo."

# game/zz_consumables.rpy:1784
translate spanish mas_consumables_candycane_finish_having_8b7b43c5:

    # m 3eua "Hold on a moment."
    m 3eua "Espera un momento."

# game/zz_consumables.rpy:1787
...
translate spanish mas_consumables_candycane_finish_having_7ae0fc82:
    ...
    m 1eua "Voy a por más. Ahora vuelvo.{w=1}{nw}"

# game/zz_consumables.rpy:1808
translate spanish mas_consumables_candycane_finish_having_cd3329c1:

    # m 1hua "Back!{w=1.5}{nw}"
    m 1hua "¡He vuelto!{w=1.5}{nw}"

# game/zz_consumables.rpy:1818
translate spanish mas_consumables_candycane_finish_having_7a2f3a16:

    # m 1eua "Okay, what else should we do today?"
    m 1eua "Vale, ¿qué más deberíamos hacer hoy?"

# game/zz_consumables.rpy:1847
...
translate spanish monika_consumables_check_f9bef97b:
    ...
    m 1eka "Te agradecería que me trajeras un poco."

# game/zz_consumables.rpy:1858
...
translate spanish monika_consumables_check_0b62c6c3:
    ...
    extend 3eua "déjame comprobar.{w=0.2}.{w=0.2}.{w=0.2}{nw}"

# game/zz_consumables.rpy:1868
translate spanish monika_consumables_check_f3309c2a:

    # m 1hub "Back!"
    m 1hub "¡He vuelto!"

# game/zz_consumables.rpy:1872
translate spanish monika_consumables_check_657c73fe:

    # m 3rksdla "I'm actually running out of a few things..."
    m 3rksdla "En realidad me estoy quedando sin algunas cosas..."

# game/zz_consumables.rpy:1873
translate spanish monika_consumables_check_eccd98ee:

    # m 3eua "I hope you don't mind, but I left you a list of things in the characters folder."
    m 3eua "Espero que no te importe, pero te he dejado una lista de cosas en la carpeta de personajes."

# game/zz_consumables.rpy:1874
translate spanish monika_consumables_check_207b80b8:

    # m 1eka "You wouldn't mind getting them for me, would you?"
    m 1eka "No te importaría traérmelas, ¿verdad?"

# game/zz_consumables.rpy:1884
...
translate spanish strings:
    ...
    # game/zz_consumables.rpy:1146
    old "Thanks, [player]~"
    new "Gracias, [player]"

    # game/zz_consumables.rpy:1198
    old "coffee"
    new "café"

    # game/zz_consumables.rpy:1211
    old "hot chocolate"
    new "chocolate caliente"

    # game/zz_consumables.rpy:1224
    old "candycane"
    new "bastón de caramelo"

    # game/zz_consumables.rpy:1244
    old "Christmas cookie"
    new "galleta de Navidad"

    # game/zz_consumables.rpy:1386
    old "I'm going to get [mas_a_an_str(container)] of [consumable.disp_name][plur]."
    new "Voy a por [mas_a_an_str(container)] de [consumable.disp_name][plur]."

    # game/zz_consumables.rpy:1390
    old "I'm going to get [mas_a_an_str(obj_ref)] of [consumable.disp_name][plur]."
    new "Voy a por [mas_a_an_str(obj_ref)] de [consumable.disp_name][plur]."

    # game/zz_consumables.rpy:1395
    old "I'm going to get [a_an] [consumable.disp_name][plur]."
    new "Voy a por [a_an] [consumable.disp_name][plur]."

    # game/zz_consumables.rpy:1447
    old "I'm going to put this [container] away."
    new "Voy a guardar este [container]."

    # game/zz_consumables.rpy:1447
    old "I'm going to get another [container]."
    new "Voy a por otro [container]."

    # game/zz_consumables.rpy:1447
    old "I'm going to put this away."
    new "Voy a guardar esto."

    # game/zz_consumables.rpy:1447
    old "I'm going to get another [obj_ref]."
    new "Voy a por otro [obj_ref]."

    # game/zz_consumables.rpy:1447
    old "I'm going to get another one."
    new "Voy a por otro."

    # game/zz_consumables.rpy:1826
