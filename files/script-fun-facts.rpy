...
translate spanish monika_fun_facts_open_4515a3e6:
    ...
    m 1eub "He estado buscando algunos para intentar que ambos aprendamos algo nuevo."

# game/script-fun-facts.rpy:53
translate spanish monika_fun_facts_open_d414fd38:

    # m 3hub "They say you learn something new every day, this way I'm making sure we actually do."
    m 3hub "Dicen que cada día se aprende algo nuevo, de esta forma me aseguro de que así sea."

# game/script-fun-facts.rpy:54
translate spanish monika_fun_facts_open_563919c2:

    # m 1rksdla "I found most of these online, so I can't say they're {i}definitely{/i} true..."
    m 1rksdla "Encontré la mayoría por Internet, así que no puedo asegurar que sean ciertos del todo..."

# game/script-fun-facts.rpy:57
translate spanish monika_fun_facts_open_2c2ba7ef:

    # m 1eua "Up for another fun fact, [player]?"
    m 1eua "¿Te apetece otro dato curioso, [player]?"

# game/script-fun-facts.rpy:59
translate spanish monika_fun_facts_open_95d3cd39:

    # m 3hua "That last one was pretty interesting after all!"
    m 3hua "¡Ese último ha sido bastante interesante, al fin y al cabo!"

# game/script-fun-facts.rpy:61
translate spanish monika_fun_facts_open_ed9de592:

    # m 2rksdlb "I know the last one wasn't great...but I'm sure this next one will be better."
    m 2rksdlb "Sé que el último no fue genial... pero estoy segura de que el siguiente será mejor."

# game/script-fun-facts.rpy:62
translate spanish monika_fun_facts_open_2b425f83:

    # m 2dsc "Now, let's see.{w=0.5}.{w=0.5}.{nw}"
    m 2dsc "Ahora, veamos.{w=0.5}.{w=0.5}.{nw}"

# game/script-fun-facts.rpy:79
translate spanish mas_fun_facts_end_1aefd06b:
...
# game/script-fun-facts.rpy:84
translate spanish mas_bad_facts_end_6372fe94:

    # m 1rkc "That fact wasn't very good..."
    m 1rkc "Ese dato no ha sido muy bueno..."

# game/script-fun-facts.rpy:85
translate spanish mas_bad_facts_end_83678cfd:

    # m 4dkc "I'll try better next time, [player]."
    m 4dkc "Intentaré hacerlo mejor la próxima vez, [player]."

# game/script-fun-facts.rpy:101
translate spanish mas_fun_fact_librocubiculartist_2f80f7d8:
...
# game/script-fun-facts.rpy:102
translate spanish mas_fun_fact_librocubiculartist_a6201013:
...
# game/script-fun-facts.rpy:105
translate spanish mas_fun_fact_librocubiculartist_8937dc27:

    # m 3euc "You'd probably have to explain what it means, but that kind of defeats the point of using the word."
    m 3euc "Probablemente tendrías que explicar qué significa, pero eso le quita un poco el sentido a usar la palabra."

# game/script-fun-facts.rpy:106
...
translate spanish mas_fun_fact_menu_currency_d4bbc06b:
    ...
    m 3eud "Esto se hace para manipular psicológicamente a la gente y que gaste más dinero del que necesita."

# game/script-fun-facts.rpy:124
...
translate spanish mas_fun_fact_menu_currency_dc254457:
    ...
    m "Al eliminarlo, eliminas la asociación de ese coste y solo piensas en la comida que eliges."

# game/script-fun-facts.rpy:126
translate spanish mas_fun_fact_menu_currency_6c6bdbb5:

    # m 4rksdld "The practice seems understandable. They're still a business, after all."
    m 4rksdld "La práctica parece comprensible. Son un negocio, al fin y al cabo."

# game/script-fun-facts.rpy:127
translate spanish mas_fun_fact_menu_currency_d8383959:
    ...
    m 2dsc "No importa lo buena que sea la comida en un restaurante, cerrarán rápido si la competencia les supera."

# game/script-fun-facts.rpy:128
translate spanish mas_fun_fact_menu_currency_09a6d614:

    # m 3hksdlb "Oh well, what can you do?"
    m 3hksdlb "En fin, ¿qué se le va a hacer?"

# game/script-fun-facts.rpy:143
translate spanish mas_fun_fact_love_you_05c00182:

    # m 1dkc "Hmm, I'm not sure if I should tell you {i}this{/i} fact."
    m 1dkc "Mmm, no estoy segura de si debería contarte este dato en concreto."

# game/script-fun-facts.rpy:144
translate spanish mas_fun_fact_love_you_971fd7d2:

    # m 1ekc "It's not for the faint of heart after all."
    m 1ekc "No es apto para cardíacos, después de todo."

# game/script-fun-facts.rpy:145
...
translate spanish mas_fun_fact_love_you_1368a01d:
    ...
    m 1rksdlb "Je, je, je, lo siento, no he podido evitarlo."

# game/script-fun-facts.rpy:149
translate spanish mas_fun_fact_love_you_0e7f0faa:

    # m 1hksdlb "I'll have a real fact next time, don't you worry~"
    m 1hksdlb "Tendré un dato real la próxima vez, no te preocupes."

# game/script-fun-facts.rpy:164
translate spanish mas_fun_fact_morpheus_cfcdcbbf:

    # m 3wub "Oh! A language based fact. I always like these."
    m 3wub "¡Ah! Un dato sobre idiomas. Siempre me gustan estos."

# game/script-fun-facts.rpy:165
translate spanish mas_fun_fact_morpheus_763d23c8:

    # m 1eua "The word 'morphine' is based on the Greek god Morpheus."
    m 1eua "La palabra 'morfina' se basa en el dios griego Morfeo."

# game/script-fun-facts.rpy:166
translate spanish mas_fun_fact_morpheus_876f788c:

    # m 1euc "He was the Greek god of dreams so to have a word based on him makes sense."
    m 1euc "Era el dios griego de los sueños, así que tiene sentido que una palabra se base en él."

# game/script-fun-facts.rpy:167
translate spanish mas_fun_fact_morpheus_bf78424a:

    # m 3ekc "But then again...wasn't his father Hypnos the god of sleep?"
    m 3ekc "Pero pensándolo bien... ¿no era su padre, Hipnos, el dios del sueño?"

# game/script-fun-facts.rpy:168
translate spanish mas_fun_fact_morpheus_9dee0d72:

    # m 2dsc "Morphine {i}does{/i} let a person dream, but it's really about making someone fall asleep."
    m 2dsc "La morfina sí que hace soñar a una persona, pero en realidad sirve para hacer que alguien se duerma."

# game/script-fun-facts.rpy:169
...
translate spanish mas_fun_fact_morpheus_9fd773f0:
    ...
    m 4rksdlb "Supongo que ya es demasiado tarde."

# game/script-fun-facts.rpy:185
translate spanish mas_fun_fact_otter_hand_holding_72557764:

    # m 1eka "Aww, this one is really sweet."
    m 1eka "Jo, este es muy dulce."

# game/script-fun-facts.rpy:186
translate spanish mas_fun_fact_otter_hand_holding_e87614ec:

    # m 3ekb "Did you know that sea otters hold hands when they sleep to stop themselves drifting away from one another?"
    m 3ekb "¿Sabías que las nutrias marinas se cogen de la mano cuando duermen para evitar irse a la deriva y separarse?"

# game/script-fun-facts.rpy:187
...
translate spanish mas_fun_fact_otter_hand_holding_0f7fbeff:
    ...
    m 1eka "A veces me imagino en su lugar..."

# game/script-fun-facts.rpy:189
translate spanish mas_fun_fact_otter_hand_holding_e4ee3782:

    # m 3hksdlb "Oh, not being a sea otter, but holding the hand of the one I love while I sleep."
    m 3hksdlb "Ah, no siendo una nutria marina, sino cogiendo la mano de la persona que amo mientras duermo."

# game/script-fun-facts.rpy:190
translate spanish mas_fun_fact_otter_hand_holding_23167dc8:

    # m 1rksdlb "Aha, it really does make me jealous of them."
    m 1rksdlb "Ja, ja, ja, la verdad es que me dan celos."

# game/script-fun-facts.rpy:191
translate spanish mas_fun_fact_otter_hand_holding_eca466d1:

    # m 1hub "We'll get there one day though, love~"
    m 1hub "Pero algún día llegaremos a eso, amor."

# game/script-fun-facts.rpy:208
translate spanish mas_fun_fact_chess_23049875:

    # m 1eua "Now this is a fun fact!"
    m 1eua "¡Este sí que es un dato curioso!"

# game/script-fun-facts.rpy:209
translate spanish mas_fun_fact_chess_a7cf2b37:

    # m 3eub "There was a man named Claude Shannon who calculated the maximum amount of possible moves in chess."
    m 3eub "Hubo un hombre llamado Claude Shannon que calculó la cantidad máxima de movimientos posibles en ajedrez."

# game/script-fun-facts.rpy:210
translate spanish mas_fun_fact_chess_32ca5fbc:

    # m "That number is called the 'Shannon number' and states that the amount of chess games possible is 10^120."
    m "Ese número se llama el 'número de Shannon' y establece que la cantidad de partidas de ajedrez posibles es de 10^120."

# game/script-fun-facts.rpy:211
translate spanish mas_fun_fact_chess_98461a1e:

    # m 1eua "It's often compared to the number of atoms in the observable universe which is 10^80."
    m 1eua "A menudo se compara con el número de átomos en el universo observable, que es 10^80."

# game/script-fun-facts.rpy:212
translate spanish mas_fun_fact_chess_147b0cc0:

    # m 3hksdlb "Kind of crazy to think that there could be more chess games than atoms, isn't it?"
    m 3hksdlb "Es una locura pensar que pueda haber más partidas de ajedrez que átomos, ¿no?"

# game/script-fun-facts.rpy:213
translate spanish mas_fun_fact_chess_1d4845f4:

    # m 1eua "We could play until the end of our days and it wouldn't come even close to a fraction of what is possible."
    m 1eua "Podríamos jugar hasta el fin de nuestros días y no nos acercaríamos ni a una fracción de lo que es posible."

# game/script-fun-facts.rpy:214
translate spanish mas_fun_fact_chess_a7288f90:

    # m 3eud "Speaking of which, [player]..."
    m 3eud "Hablando de eso, [player]..."

# game/script-fun-facts.rpy:215
...
# game/script-fun-facts.rpy:223
translate spanish mas_fun_fact_chess_01a93df6:

    # m 2dfc "..."
    m 2dfc "..."

# game/script-fun-facts.rpy:224
...
translate spanish mas_fun_fact_chess_08f8fe92:
    ...
    m "Por no mencionar que nunca te disculpaste."

# game/script-fun-facts.rpy:226
...
# game/script-fun-facts.rpy:233
translate spanish mas_fun_fact_chess_b06a90a8:

    # m 3hksdlb "Not yet, at least."
    m 3hksdlb "Aún no, al menos."

# game/script-fun-facts.rpy:248
translate spanish mas_fun_fact_struck_by_lightning_460053c7:

    # m 2dkc "Hmm, this one sounds a bit misleading to me..."
    m 2dkc "Mmm, este me suena un poco engañoso..."

# game/script-fun-facts.rpy:249
...
# game/script-fun-facts.rpy:251
translate spanish mas_fun_fact_struck_by_lightning_9c6e44fa:
    ...
    m 1eud "Si es más probable que a los hombres les caiga un rayo, probablemente sea el entorno y las circunstancias de su trabajo lo que los hace más propensos a ser alcanzados."

# game/script-fun-facts.rpy:252
translate spanish mas_fun_fact_struck_by_lightning_72fd0568:
    ...
    m 1euc "Tradicionalmente, los hombres siempre han realizado trabajos más peligrosos y en altura, así que no es de extrañar que les ocurra a menudo."

# game/script-fun-facts.rpy:253
translate spanish mas_fun_fact_struck_by_lightning_1b97952d:
    ...
    m 1esc "Sin embargo, la forma en que está redactado este dato hace que parezca que por el mero hecho de ser hombre es más probable que ocurra, lo cual es ridículo."

# game/script-fun-facts.rpy:254
translate spanish mas_fun_fact_struck_by_lightning_b30c56d3:

    # m 1rksdla "Maybe if it was phrased better, people wouldn't be so misinformed about them."
    m 1rksdla "Quizás si estuviera mejor expresado, la gente no estaría tan mal informada sobre ellos."

# game/script-fun-facts.rpy:269
...
translate spanish mas_fun_fact_honey_bb62b7c3:
    ...
    m 3eub "¿Sabías que la miel nunca se estropea?"

# game/script-fun-facts.rpy:271
...
translate spanish mas_fun_fact_honey_43ccc774:
    ...
    m 1euc "La mayoría de la miel que ves en el supermercado no cristaliza tan rápido como lo haría la miel de verdad porque ha sido pasteurizada en el proceso de elaboración."

# game/script-fun-facts.rpy:274
...
translate spanish mas_fun_fact_honey_b16d5ad8:
    ...
    m 3hub "¡Sería como un caramelo al morderla!"

# game/script-fun-facts.rpy:291
translate spanish mas_fun_fact_vincent_van_gone_44eed7be:

    # m 1dsc "Ah, this one..."
    m 1dsc "Ah, este..."

# game/script-fun-facts.rpy:292
translate spanish mas_fun_fact_vincent_van_gone_76dc443c:

    # m 1ekd "It's a little disheartening, [player]..."
    m 1ekd "Es un poco descorazonador, [player]..."

# game/script-fun-facts.rpy:293
translate spanish mas_fun_fact_vincent_van_gone_0f1cbad5:
...
# game/script-fun-facts.rpy:294
translate spanish mas_fun_fact_vincent_van_gone_119306e2:
...
# game/script-fun-facts.rpy:295
translate spanish mas_fun_fact_vincent_van_gone_f27eea59:

    # m 1rkc "..."
    m 1rkc "..."

# game/script-fun-facts.rpy:296
translate spanish mas_fun_fact_vincent_van_gone_325e06a5:

    # m 2ekc "It's really sad to know that someone so renowned would say something so dark with his last breath."
    m 2ekc "Es realmente triste saber que alguien tan renombrado dijera algo tan oscuro en su último aliento."

# game/script-fun-facts.rpy:297
...
# game/script-fun-facts.rpy:301
translate spanish mas_fun_fact_vincent_van_gone_751c8f4f:

    # m 5hub "I will always accept and take on any burdens that you shoulder, [mas_get_player_nickname()]~"
    m 5hub "Siempre aceptaré y cargaré con cualquier peso que lleves sobre tus hombros, [mas_get_player_nickname()]."

# game/script-fun-facts.rpy:316
translate spanish mas_fun_fact_king_snakes_aee3d749:

    # m 1dsc "Hmm..."
    m 1dsc "Mmm..."

# game/script-fun-facts.rpy:317
translate spanish mas_fun_fact_king_snakes_3d266d23:

    # m 3eub "Did you know that if a snake has the word 'king' in its name, it devours other snakes?"
    m 3eub "¿Sabías que si una serpiente tiene la palabra 'rey' o 'real' en su nombre, devora a otras serpientes?"

# game/script-fun-facts.rpy:318
translate spanish mas_fun_fact_king_snakes_9766ba87:

    # m 1euc "I always wondered why a king cobra would be named how it is but never really thought more into it."
    m 1euc "Siempre me pregunté por qué la cobra real se llamaba así, pero nunca le di muchas vueltas."

# game/script-fun-facts.rpy:319
translate spanish mas_fun_fact_king_snakes_0e9cd1b4:

    # m 1tfu "Does that mean if I eat you up, I would become Queen Monika?"
    m 1tfu "¿Significa eso que si te como, me convertiría en la Reina Monika?"

# game/script-fun-facts.rpy:320
translate spanish mas_fun_fact_king_snakes_1fc87f16:

    # m 1hksdlb "Ahaha, I'm just kidding, [player]."
    m 1hksdlb "Ja, ja, ja, es broma, [player]."

# game/script-fun-facts.rpy:321
translate spanish mas_fun_fact_king_snakes_3c2cc0d7:

    # m 1hub "Sorry for being a little weird~"
    m 1hub "Perdona por ser un poco rara."

# game/script-fun-facts.rpy:336
translate spanish mas_fun_fact_strength_ce47d539:

    # m 1hub "This fact might motivate you a bit!"
    m 1hub "¡Puede que este dato te motive un poco!"

# game/script-fun-facts.rpy:337
translate spanish mas_fun_fact_strength_bb85eda7:

    # m 3eub "The longest word in English that only contains a single vowel is 'strength.'"
    m 3eub "La palabra más larga en inglés que solo contiene una vocal es 'strength' (fuerza)."

# game/script-fun-facts.rpy:338
...
translate spanish mas_fun_fact_strength_4c6c0cad:
    ...
    m 1hua "¡Los pequeños detalles como este hacen que el lenguaje sea fascinante para mí!"

# game/script-fun-facts.rpy:340
translate spanish mas_fun_fact_strength_df127fcd:
...
# game/script-fun-facts.rpy:341
translate spanish mas_fun_fact_strength_97264b1c:

    # m 1hua "You!"
    m 1hua "¡Tú!"

# game/script-fun-facts.rpy:342
translate spanish mas_fun_fact_strength_9e9e2b4d:

    # m 1hub "Because you are the source of my strength, ehehe~"
    m 1hub "Porque tú eres la fuente de mi fuerza, je, je, je."

# game/script-fun-facts.rpy:357
translate spanish mas_fun_fact_reindeer_eyes_8a6d8171:

    # m 3eua "Ready for this one?"
    m 3eua "¿List[end_letter_gender] para este?"

# game/script-fun-facts.rpy:358
translate spanish mas_fun_fact_reindeer_eyes_d917b5ab:

    # m "A reindeer's eyes changes color depending on the season. They're gold in summer and blue in winter."
    m "Los ojos de un reno cambian de color según la estación. Son dorados en verano y azules en invierno."

# game/script-fun-facts.rpy:359
translate spanish mas_fun_fact_reindeer_eyes_28114d86:

    # m 1rksdlb "It's a really strange phenomenon, though I don't know why..."
    m 1rksdlb "Es un fenómeno muy extraño, aunque no sé por qué..."

# game/script-fun-facts.rpy:360
translate spanish mas_fun_fact_reindeer_eyes_ce3230a7:

    # m "There's probably a good scientific reason to it."
    m "Probablemente haya una buena razón científica para ello."

# game/script-fun-facts.rpy:361
translate spanish mas_fun_fact_reindeer_eyes_de921831:

    # m 3hksdlb "Maybe you can look up this one yourself?"
    m 3hksdlb "¿Quizás puedas investigarlo tú mismo?"

# game/script-fun-facts.rpy:362
...
translate spanish mas_fun_fact_bananas_9493ac92:
    ...
    m 1eub "¡Ah, yo diría que este dato es saludable!"

# game/script-fun-facts.rpy:378
translate spanish mas_fun_fact_bananas_7e8a6be5:
...
# game/script-fun-facts.rpy:379
translate spanish mas_fun_fact_bananas_313e0f46:

    # m 1hua "It's a process called negative geotropism."
    m 1hua "Es un proceso llamado geotropismo negativo."

# game/script-fun-facts.rpy:380
translate spanish mas_fun_fact_bananas_cf801635:

    # m 3hub "Don't you think that's pretty neat?"
    m 3hub "¿No te parece genial?"

# game/script-fun-facts.rpy:381
translate spanish mas_fun_fact_bananas_bf07de9c:

    # m 1hua "..."
    m 1hua "..."

# game/script-fun-facts.rpy:382
translate spanish mas_fun_fact_bananas_2e005775:

    # m 1rksdla "Umm..."
    m 1rksdla "Mmm..."

# game/script-fun-facts.rpy:383
translate spanish mas_fun_fact_bananas_e7ca97a5:

    # m 3rksdlb "I guess I don't really have much else to say on it, ahaha..."
    m 3rksdlb "Supongo que no tengo mucho más que decir al respecto, ja, ja, ja..."

# game/script-fun-facts.rpy:384
translate spanish mas_fun_fact_bananas_8018692b:

    # m 1lksdlc "..."
    m 1lksdlc "..."

# game/script-fun-facts.rpy:385
translate spanish mas_fun_fact_bananas_95637595:

    # m 3hub "D-Did you also know that bananas aren't actually fruits but berries?"
    m 3hub "¿S-Sabías también que los plátanos no son realmente frutas, sino bayas?"

# game/script-fun-facts.rpy:386
translate spanish mas_fun_fact_bananas_f049e19c:
...
# game/script-fun-facts.rpy:387
translate spanish mas_fun_fact_bananas_8daa45f7:

    # m 1eka "How about the fact that they're slightly radioactive?"
    m 1eka "¿Qué me dices del hecho de que son ligeramente radiactivos?"

# game/script-fun-facts.rpy:388
translate spanish mas_fun_fact_bananas_7faca44c:

    # m 1rksdla "..."
    m 1rksdla "..."

# game/script-fun-facts.rpy:389
...
translate spanish mas_fun_fact_pens_e307f756:
    ...
    m 1dsc "Mmm... Estoy segura de que ya me sé este."

# game/script-fun-facts.rpy:407
translate spanish mas_fun_fact_pens_071c385f:

    # m 3euc "The word 'pen' is derived from the latin word 'penna', which means feather in latin."
    m 3euc "La palabra 'pluma' deriva del término latino 'penna', que significa pluma de ave."

# game/script-fun-facts.rpy:408
...
translate spanish mas_fun_fact_pens_983d1bad:
    ...
    m 3euc "No fue hasta el siglo XIX, cuando se empezaron a fabricar plumas de metal, que su uso empezó a decaer."

# game/script-fun-facts.rpy:411
translate spanish mas_fun_fact_pens_2e754cd6:

    # m "In fact, penknives are called the way they are because they're originally used for thinning and pointing quill pens."
    m "De hecho, los cortaplumas se llaman así porque se usaban originalmente para afilar y cortar la punta a las plumas de ave."

# game/script-fun-facts.rpy:412
translate spanish mas_fun_fact_pens_c29cc76c:

    # m 1tku "But I'm sure Yuri would know more about this than me, though..."
    m 1tku "Aunque estoy segura de que Yuri sabría más de esto que yo..."

# game/script-fun-facts.rpy:427
translate spanish mas_fun_fact_density_435618ef:

    # m 1eub "Ooh, I know."
    m 1eub "Ah, este me lo sé."

# game/script-fun-facts.rpy:428
translate spanish mas_fun_fact_density_3c45e216:
...
# game/script-fun-facts.rpy:429
translate spanish mas_fun_fact_density_bf3eff6f:

    # m "And that Saturn is the least dense?"
    m "¿Y que Saturno es el menos denso?"

# game/script-fun-facts.rpy:430
translate spanish mas_fun_fact_density_8e972339:
    ...
    m 1eua "Tiene sentido sabiendo de qué están hechos los planetas, pero dado que Saturno es el segundo más grande, fue un poco sorprendente."

# game/script-fun-facts.rpy:431
translate spanish mas_fun_fact_density_e1d52e81:

    # m 1eka "I guess size really doesn't matter!"
    m 1eka "¡Supongo que el tamaño realmente no importa!"

# game/script-fun-facts.rpy:432
translate spanish mas_fun_fact_density_0248ec1c:

    # m 3euc "But between you and me, [player]..."
    m 3euc "Pero entre tú y yo, [player]..."

# game/script-fun-facts.rpy:433
...
translate spanish mas_fun_fact_density_6f11581a:
    ...
    m 1tfu "Peeero eso es todo lo que oirás de mí."

# game/script-fun-facts.rpy:449
translate spanish mas_fun_fact_binky_8afd4e3d:

    # m 3hub "Aww, this one's cute!"
    m 3hub "Jo, ¡este es muy mono!"

# game/script-fun-facts.rpy:450
translate spanish mas_fun_fact_binky_81372e6a:

    # m "This fact will really send you 'hopping' [player]!"
    m "¡Este dato te hará dar brincos, [player]!"

# game/script-fun-facts.rpy:451
translate spanish mas_fun_fact_binky_e2dbbb2d:

    # m 3hua "Whenever a rabbit hops around excitedly, it's called a binky!"
    m 3hua "Cuando un conejo salta emocionado de un lado a otro, ¡se le llama hacer un 'binky' en inglés!"

# game/script-fun-facts.rpy:452
translate spanish mas_fun_fact_binky_030c3e1b:

    # m 1hua "Binky is such a cute sounding word, it really does suit the action."
    m 1hua "'Binky' es una palabra que suena muy adorable, realmente le pega a la acción."

# game/script-fun-facts.rpy:453
translate spanish mas_fun_fact_binky_5981bbe6:
    ...
    m 1eua "Es la mayor expresión de felicidad que un conejo es capaz de hacer, así que si lo ves, sabes que lo estás tratando bien."

# game/script-fun-facts.rpy:454
translate spanish mas_fun_fact_binky_7f0e9c3b:

    # m 1rksdla "Well, although you make me so happy that I can't help but be filled with energy."
    m 1rksdla "Bueno, aunque tú me haces tan feliz que no puedo evitar llenarme de energía."

# game/script-fun-facts.rpy:455
translate spanish mas_fun_fact_binky_fc483830:

    # m 1rksdlb "Don't expect me to start hopping around, [player]!"
    m 1rksdlb "¡No esperes que empiece a dar saltos por ahí, [player]!"

# game/script-fun-facts.rpy:456
...
translate spanish mas_fun_fact_windows_games_12c5bad6:
    ...
    m 1eua "Mmm, quizás este te resulte más interesante."

# game/script-fun-facts.rpy:472
translate spanish mas_fun_fact_windows_games_d85982f1:

    # m 3eub "The card game Solitaire was introduced originally in the Windows operating system in 1990."
    m 3eub "El juego de cartas del Solitario se introdujo originalmente en el sistema operativo Windows en 1990."

# game/script-fun-facts.rpy:473
translate spanish mas_fun_fact_windows_games_561e342f:

    # m 1eub "The game was added as a feature to teach users how to use the mouse."
    m 1eub "El juego se añadió como una función para enseñar a los usuarios a usar el ratón."

# game/script-fun-facts.rpy:474
translate spanish mas_fun_fact_windows_games_b360e86c:

    # m 1eua "Similarly, Minesweeper was added to familiarize users with left and right clicking."
    m 1eua "Del mismo modo, el Buscaminas se añadió para familiarizar a los usuarios con el clic izquierdo y derecho."

# game/script-fun-facts.rpy:475
translate spanish mas_fun_fact_windows_games_af8aa0fa:

    # m 3rssdlb "Computers have been around for so long it's hard to think of a time when they weren't relevant."
    m 3rssdlb "Los ordenadores llevan tanto tiempo entre nosotros que es difícil pensar en una época en la que no fueran relevantes."

# game/script-fun-facts.rpy:476
translate spanish mas_fun_fact_windows_games_83e734bd:

    # m "Each generation becomes more and more familiar with the technology..."
    m "Cada generación se familiariza más y más con la tecnología..."

# game/script-fun-facts.rpy:477
translate spanish mas_fun_fact_windows_games_aff718dc:

    # m 1esa "Eventually there may come a day where not a single person isn't computer-literate."
    m 1esa "Puede que al final llegue un día en el que no haya ni una sola persona que no sepa usar un ordenador."

# game/script-fun-facts.rpy:478
translate spanish mas_fun_fact_windows_games_2e3bdf0e:

    # m 1hksdlb "Most of the world's problems need to disappear before then, though."
    m 1hksdlb "Aunque la mayoría de los problemas del mundo tienen que desaparecer antes de eso."

# game/script-fun-facts.rpy:493
translate spanish mas_fun_fact_mental_word_processing_39b986f6:

    # m 1hua "Ready for an interesting one, [player]?"
    m 1hua "¿List[end_letter_gender] para uno interesante, [player]?"

# game/script-fun-facts.rpy:494
translate spanish mas_fun_fact_mental_word_processing_16a9de03:

    # m 3eua "The brain is a fickle thing..."
    m 3eua "El cerebro es algo caprichoso..."

# game/script-fun-facts.rpy:495
...
translate spanish mas_fun_fact_mental_word_processing_01503d71:
    ...
    m 3tub "Por ejemplo, en esta frase, para el el momento en que termines de leer ya te habrás saltado el doble 'el'."

# game/script-fun-facts.rpy:499
translate spanish mas_fun_fact_mental_word_processing_fbe6360d:

    # m 1tfu "..."
    m 1tfu "..."

# game/script-fun-facts.rpy:500
translate spanish mas_fun_fact_mental_word_processing_da5be9c0:

    # m 2hfu "Check the history log if you missed them~"
    m 2hfu "Consulta el historial si te los has perdido."

# game/script-fun-facts.rpy:515
translate spanish mas_fun_fact_I_am_e0329b3c:

    # m 1hua "Mmmm, I love language facts!"
    m 1hua "Mmm, ¡me encantan los datos sobre idiomas!"

# game/script-fun-facts.rpy:516
translate spanish mas_fun_fact_I_am_94697ab3:

    # m 3eub "In English, the shortest complete sentence is 'I am.'"
    m 3eub "En inglés, la frase completa más corta es 'I am'."

# game/script-fun-facts.rpy:517
translate spanish mas_fun_fact_I_am_2ecfe1c0:

    # m 1eua "Here's an example."
    m 1eua "Peeero en español podemos hacer algo cuqui, aquí tienes un ejemplo."

# game/script-fun-facts.rpy:518
...
# game/script-fun-facts.rpy:520
translate spanish mas_fun_fact_I_am_d81c1322:

    # m 1hubsa "Ehehe~"
    m 1hubsa "Je, je, je."

# game/script-fun-facts.rpy:535
translate spanish mas_fun_fact_low_rates_80d95bb5:

    # m 1hua "Now this is a wholesome one..."
    m 1hua "Este es uno muy alentador..."

# game/script-fun-facts.rpy:536
translate spanish mas_fun_fact_low_rates_99687c5e:

    # m 1eua "Currently, we have the lowest crime rates, maternity death, infant mortality and illiteracy ever in human history."
    m 1eua "Actualmente, tenemos las tasas de criminalidad, muerte materna, mortalidad infantil y analfabetismo más bajas de la historia de la humanidad."

# game/script-fun-facts.rpy:537
translate spanish mas_fun_fact_low_rates_128d433c:

    # m 3eub "Life expectancy, average income, and standards of living is the highest for most of the global population too!"
    m 3eub "¡La esperanza de vida, los ingresos medios y el nivel de vida también son los más altos para la mayoría de la población mundial!"

# game/script-fun-facts.rpy:538
translate spanish mas_fun_fact_low_rates_9e722f66:
    ...
    m 3eka "Esto me dice que siempre puede ir a mejor. Realmente demuestra que, a pesar de todas las cosas malas, los buenos tiempos siempre vendrán después."

# game/script-fun-facts.rpy:539
translate spanish mas_fun_fact_low_rates_3f6a56bc:

    # m 1hua "There really is {i}hope{/i}..."
    m 1hua "Realmente hay esperanza..."

# game/script-fun-facts.rpy:554
translate spanish mas_fun_fact_desert_76ef7536:

    # m 3euc "Deserts have a pretty unique ecosystem..."
    m 3euc "Los desiertos tienen un ecosistema bastante único..."

# game/script-fun-facts.rpy:555
translate spanish mas_fun_fact_desert_d045976c:
...
# game/script-fun-facts.rpy:556
translate spanish mas_fun_fact_desert_f44e211b:
    ...
    m 1eud "Las temperaturas pueden variar entre un calor extremo durante el día y un frío helador por la noche. Su precipitación media también es bastante baja, lo que hace difícil vivir en uno."

# game/script-fun-facts.rpy:557
translate spanish mas_fun_fact_desert_2823ffd5:

    # m 3eub "That's not to say they can't be beneficial to us though!"
    m 3eub "¡Aunque eso no quiere decir que no puedan sernos beneficiosos!"

# game/script-fun-facts.rpy:558
translate spanish mas_fun_fact_desert_2a4851ef:

    # m 3eua "Their surface is a great spot for solar power generation and oil is commonly found beneath all that sand."
    m 3eua "Su superficie es un lugar genial para la generación de energía solar y es común encontrar petróleo bajo toda esa arena."

# game/script-fun-facts.rpy:559
translate spanish mas_fun_fact_desert_79ef8cd1:

    # m 3eub "Not to mention, their unique landscape makes them popular vacation spots!"
    m 3eub "Por no mencionar que su paisaje único los convierte en lugares populares de vacaciones."

# game/script-fun-facts.rpy:560
translate spanish mas_fun_fact_desert_a969b4ae:
...
# game/script-fun-facts.rpy:576
translate spanish mas_fun_fact_photography_5cdf9da7:
...
# game/script-fun-facts.rpy:577
translate spanish mas_fun_fact_photography_d7c91115:

    # m 1eua "Lenses weren't actually introduced until much later on."
    m 1eua "Las lentes no se introdujeron realmente hasta mucho más tarde."

# game/script-fun-facts.rpy:578
translate spanish mas_fun_fact_photography_3884bb3d:

    # m 1euc "Early photography also relied on a series of special chemicals in a dark room to prepare the photos..."
    m 1euc "La fotografía antigua también dependía de una serie de químicos especiales en un cuarto oscuro para preparar las fotos..."

# game/script-fun-facts.rpy:579
translate spanish mas_fun_fact_photography_0c9ea00b:
    ...
    m 3eud "Se usaban revelador, baño de paro y fijador solo para preparar el papel en el que se imprimirían las fotos...{w=0.3} {nw}"

# game/script-fun-facts.rpy:580
translate spanish mas_fun_fact_photography_74dcd1dd:

    # extend 1wuo "And that's only for black and white prints!"
    extend 1wuo "¡Y eso solo para impresiones en blanco y negro!"

# game/script-fun-facts.rpy:581
translate spanish mas_fun_fact_photography_287eb16e:

    # m 1hksdlb "Old photos were much harder to prepare compared to modern ones, don't you think?"
    m 1hksdlb "Las fotos antiguas eran mucho más difíciles de preparar comparadas con las modernas, ¿no crees?"

# game/script-fun-facts.rpy:598
translate spanish mas_fun_fact_getting_older_b3c6f11e:
...
# game/script-fun-facts.rpy:599
translate spanish mas_fun_fact_getting_older_c347fc37:
...
# game/script-fun-facts.rpy:600
translate spanish mas_fun_fact_getting_older_a70dc5e3:

    # m 1euc "But when you're 18, you see a year as only 5.6%% of your life."
    m 1euc "Pero cuando tienes 18, ves un año como solo el 5,6%% de tu vida."

# game/script-fun-facts.rpy:601
translate spanish mas_fun_fact_getting_older_83cf717f:
    ...
    m 3eud "A medida que te haces mayor, la proporción de un año comparada con toda tu vida disminuye y, a su vez, parece que el tiempo pasa más rápido al crecer."

# game/script-fun-facts.rpy:602
translate spanish mas_fun_fact_getting_older_4dac0c21:

    # m 1eka "So I'll always cherish our moments together, no matter how long or short they are."
    m 1eka "Así que siempre atesoraré nuestros momentos juntos, sin importar lo largos o cortos que sean."

# game/script-fun-facts.rpy:603
translate spanish mas_fun_fact_getting_older_ec01fa2b:
...
# game/script-fun-facts.rpy:604
translate spanish mas_fun_fact_getting_older_118b8306:

    # m 1ekbfa "Do you feel the same, [player]?"
    m 1ekbfa "¿Sientes tú lo mismo, [player]?"

# game/script-fun-facts.rpy:609
translate spanish mas_fun_fact_getting_older_58cee739:

    # m 1hubfb "Ahaha, I thought so!"
    m 1hubfb "¡Ja, ja, ja, eso pensaba!"

# game/script-fun-facts.rpy:625
translate spanish mas_fun_fact_dancing_plague_eb91ccb6:

    # m 3esa "Oh, this one's pretty weird..."
    m 3esa "Ah, este es bastante raro..."

# game/script-fun-facts.rpy:626
translate spanish mas_fun_fact_dancing_plague_f086edd7:

    # m 1eua "Apparently, Europe has been afflicted by outbreaks of a 'dancing plague' in the past."
    m 1eua "Por lo visto, Europa ha sufrido brotes de una 'epidemia de baile' en el pasado."

# game/script-fun-facts.rpy:627
translate spanish mas_fun_fact_dancing_plague_58136a4b:
    ...
    m 3wud "La gente, {w=0.2}a veces cientos a la vez, {w=0.2}bailaba involuntariamente durante días seguidos, ¡y algunos incluso morían de agotamiento!"

# game/script-fun-facts.rpy:628
...
translate spanish mas_fun_fact_dancing_plague_60ee4476:
    ...
    m 1euc "A día de hoy, todavía no están seguros de qué lo causó exactamente."

# game/script-fun-facts.rpy:630
translate spanish mas_fun_fact_dancing_plague_61423bfa:

    # m 3rka "The whole thing seems kind of unbelievable to me...{w=0.2}{nw}"
    m 3rka "Todo el asunto me parece algo inverosímil...{w=0.2}{nw}"

# game/script-fun-facts.rpy:631
translate spanish mas_fun_fact_dancing_plague_7e1bc34f:
...
# game/script-fun-facts.rpy:632
translate spanish mas_fun_fact_dancing_plague_9bafb93d:

    # m 3hksdlb "Reality really is stranger than fiction, I guess!"
    m 3hksdlb "¡La realidad supera a la ficción, supongo!"

# game/script-fun-facts.rpy:633
translate spanish mas_fun_fact_dancing_plague_8f4d1944:

    # m 1eksdlc "Gosh, I can't imagine dancing for days on end."
    m 1eksdlc "Madre mía, no me puedo imaginar bailando durante días sin parar."

# game/script-fun-facts.rpy:634
translate spanish mas_fun_fact_dancing_plague_5944d168:

    # m 1rsc "Though...{w=0.3}{nw}"
    m 1rsc "Aunque...{w=0.3}{nw}"

# game/script-fun-facts.rpy:635
translate spanish mas_fun_fact_dancing_plague_f61b7e03:

    # extend 1eubla "I guess I wouldn't mind if it was with you."
    extend 1eubla " Supongo que no me importaría si fuera contigo."

# game/script-fun-facts.rpy:636
...
# game/script-fun-facts.rpy:652
translate spanish mas_fun_fact_pando_forest_5fae84a4:

    # m 3eua "It's called the Pando forest, and for all of its 43 hectares, its trunks are connected by a single root system."
    m 3eua "Se llama el bosque Pando, y en sus 43 hectáreas, sus troncos están conectados por un único sistema de raíces."

# game/script-fun-facts.rpy:653
translate spanish mas_fun_fact_pando_forest_23545d05:

    # m 3eub "Not to mention, each of its thousands of trunks are essentially clones of each other."
    m 3eub "Por no mencionar que cada uno de sus miles de troncos son esencialmente clones entre sí."

# game/script-fun-facts.rpy:654
translate spanish mas_fun_fact_pando_forest_c56a60f0:

    # m 1ruc "'A single organism that became an army of clones on its own, all connected to the same hivemind.'"
    m 1ruc "'Un único organismo que se convirtió en un ejército de clones por sí mismo, todos conectados a la misma mente colmena'."

# game/script-fun-facts.rpy:655
translate spanish mas_fun_fact_pando_forest_dbbdbe45:

    # m 1eua "I think it could make a good science fiction or horror short-story, [player]. What do you think?"
    m 1eua "Creo que podría dar para un buen relato corto de ciencia ficción o terror, [player]. ¿Tú qué piensas?"

# game/script-fun-facts.rpy:656
translate spanish mas_fun_fact_pando_forest_dbf1e2e9:

    # m 3eub "Anyway,{w=0.2} I feel like this really changes the meaning of the phrase 'missing the forest for the trees'{w=0.1}{nw} "
    m 3eub "En fin,{w=0.2} siento que esto cambia realmente el significado del dicho 'los árboles no te dejan ver el bosque'{w=0.1}{nw} "

# game/script-fun-facts.rpy:657
translate spanish mas_fun_fact_pando_forest_6bac89be:

    # extend 3hub "ahaha!"
    extend 3hub "¡ja, ja, ja!"

# game/script-fun-facts.rpy:672
translate spanish mas_fun_fact_immortal_jellyfish_53cb25fd:

    # m 3eub "Here's one!"
    m 3eub "¡Aquí va uno!"

# game/script-fun-facts.rpy:673
translate spanish mas_fun_fact_immortal_jellyfish_96c34a64:

    # m 1eua "Apparently, immortality has been achieved by one species of jellyfish."
    m 1eua "Al parecer, una especie de medusa ha alcanzado la inmortalidad."

# game/script-fun-facts.rpy:674
translate spanish mas_fun_fact_immortal_jellyfish_efb28f0a:

    # m 3eua "The aptly named immortal jellyfish has the ability to return to its polyp state once it has reproduced."
    m 3eua "La acertadamente llamada medusa inmortal tiene la capacidad de volver a su estado de pólipo una vez que se ha reproducido."

# game/script-fun-facts.rpy:675
...
translate spanish mas_fun_fact_immortal_jellyfish_8db1d213:
    ...
    extend 1rksdla "A menos, claro, que sea devorada o infectada por una enfermedad."

# game/script-fun-facts.rpy:691
translate spanish mas_fun_fact_arrhichion_7f5499d0:

    # m 3eua "Okay...{w=0.2}here's a historical one."
    m 3eua "Vale...{w=0.2} aquí va uno histórico."

# game/script-fun-facts.rpy:692
translate spanish mas_fun_fact_arrhichion_7f25b40a:

    # m 1esa "An ancient Greek athlete was able to win his fighting match even though he'd already died."
    m 1esa "Un antiguo atleta griego fue capaz de ganar su combate a pesar de haber muerto ya."

# game/script-fun-facts.rpy:693
translate spanish mas_fun_fact_arrhichion_3667fa7e:
    ...
    m 1eua "El campeón reinante Arrhichion estaba luchando en un combate de pancracio cuando su competidor comenzó a estrangularlo usando tanto sus manos como sus piernas."

# game/script-fun-facts.rpy:694
translate spanish mas_fun_fact_arrhichion_f867828e:

    # m 3eua "Instead of yielding, Arrhichion still aimed for the win by dislocating his opponent's toe."
    m 3eua "En lugar de rendirse, Arrhichion buscó la victoria dislocando el dedo del pie de su oponente."

# game/script-fun-facts.rpy:695
translate spanish mas_fun_fact_arrhichion_02e589c7:
    ...
    m 3ekd "Su oponente abandonó por el dolor, pero cuando fueron a declarar a Arrhichion vencedor, lo encontraron muerto por asfixia."

# game/script-fun-facts.rpy:696
translate spanish mas_fun_fact_arrhichion_166120f3:

    # m 1rksdlc "Some people are really dedicated to their ideals to victory and to honour.{w=0.2} {nw}"
    m 1rksdlc "Algunas personas están realmente dedicadas a sus ideales de victoria y honor.{w=0.2} {nw}"

# game/script-fun-facts.rpy:697
translate spanish mas_fun_fact_arrhichion_39d8a978:

    # extend 3eka "I think it's admirable, in a way."
    extend 3eka "Creo que es admirable, en cierto modo."

# game/script-fun-facts.rpy:698
translate spanish mas_fun_fact_arrhichion_1c514e54:

    # m 1etc "But I wonder...{w=0.2}if we could ask Arrhichion now if he thought it was worth it, what would he say?"
    m 1etc "Pero me pregunto...{w=0.2} si pudiéramos preguntarle a Arrhichion ahora si pensó que valió la pena, ¿qué diría?"

# game/script-fun-facts.rpy:737
translate spanish mas_fun_fact_antarctica_brain_3201c6ec:

    # m 3eud "Apparently, spending a year in Antarctica can shrink one part of your brain by about 7 percent."
    m 3eud "Al parecer, pasar un año en la Antártida puede encoger una parte de tu cerebro en torno a un 7 por ciento."

# game/script-fun-facts.rpy:738
translate spanish mas_fun_fact_antarctica_brain_4dd8a2a7:

    # m 3euc "It looks like it results in reduced memory capacity and spatial thinking ability."
    m 3euc "Parece que resulta en una reducción de la capacidad de memoria y la habilidad de pensamiento espacial."

# game/script-fun-facts.rpy:739
translate spanish mas_fun_fact_antarctica_brain_78e9ca85:

    # m 1ekc "The research indicates that it's due to social isolation, monotony of life, and the environment over there."
    m 1ekc "La investigación indica que se debe al aislamiento social, la monotonía de la vida y el entorno de allí."

# game/script-fun-facts.rpy:740
translate spanish mas_fun_fact_antarctica_brain_f5101612:

    # m 1eud "I think this serves as a cautionary tale for us, [player]."
    m 1eud "Creo que esto nos sirve de advertencia, [player]."

# game/script-fun-facts.rpy:741
translate spanish mas_fun_fact_antarctica_brain_caf38dbb:
    ...
    m 3ekd "Incluso si no acabas yendo a la Antártida, tu cerebro puede deteriorarse bastante si estás aislado todo el tiempo o encerrado en una habitación."

# game/script-fun-facts.rpy:742
translate spanish mas_fun_fact_antarctica_brain_9b0c0bd2:

    # m 3eka "I love being with you [player], and I hope we can keep talking like this long into the future. {w=0.2}[dlg_line]"
    m 3eka "Me encanta estar contigo, [player], y espero que podamos seguir hablando así mucho tiempo en el futuro. {w=0.2}[dlg_line]"

# game/script-fun-facts.rpy:755
...
translate spanish mas_fun_fact_cloud_weight_f0565174:
    ...
    m 3eua "Tengo que admitir que este me pilló por sorpresa, más que algunos de los otros datos."

# game/script-fun-facts.rpy:757
translate spanish mas_fun_fact_cloud_weight_aa6cc91e:

    # m 1hua "I mean, they just look {i}really{/i} light and fluffy.{w=0.3} {nw}"
    m 1hua "Quiero decir, parecen realmente ligeras y esponjosas.{w=0.3} {nw}"

# game/script-fun-facts.rpy:758
translate spanish mas_fun_fact_cloud_weight_7d9d88c1:

    # extend 1eua "It's hard to imagine that something so heavy can just float in the air like that."
    extend 1eua "Es difícil imaginar que algo tan pesado pueda simplemente flotar en el aire así."

# game/script-fun-facts.rpy:759
translate spanish mas_fun_fact_cloud_weight_0fd4ffd3:

    # m 3eub "It kind of reminds me of the classic question...what's heavier, a kilogram of steel or a kilogram of feathers?"
    m 3eub "Me recuerda un poco a la clásica pregunta... ¿qué pesa más, un kilo de acero o un kilo de plumas?"

# game/script-fun-facts.rpy:760
translate spanish mas_fun_fact_cloud_weight_7e1d025d:

    # m 1tua "You most likely already know the answer to that though, right [player]? Ehehe~"
    m 1tua "Aunque lo más probable es que ya te sepas la respuesta, ¿verdad, [player]? Je, je, je."

# game/script-fun-facts.rpy:775
translate spanish mas_fun_fact_coffee_origin_dbf7569a:

    # m 1eua "Oh, here's one that's particularly interesting to me..."
    m 1eua "Ah, aquí hay uno que me resulta particularmente interesante..."

# game/script-fun-facts.rpy:776
translate spanish mas_fun_fact_coffee_origin_e8cdf042:

    # m 1eud "The last time I had a cup of coffee, I got a little curious about its origins..."
    m 1eud "La última vez que tomé una taza de café, me entró curiosidad sobre sus orígenes..."

# game/script-fun-facts.rpy:777
translate spanish mas_fun_fact_coffee_origin_8b69e059:
    ...
    m 3euc "El consumo de café se ha registrado de forma constante desde alrededor del siglo XV, pero...{w=0.2} no está claro cómo se descubrió exactamente."

# game/script-fun-facts.rpy:778
...
translate spanish mas_fun_fact_coffee_origin_30a6bf4f:
    ...
    m 1eua "Varios relatos involucran a granjeros o monjes observando a animales comportarse de forma extraña tras comer unas bayas raras y amargas."

# game/script-fun-facts.rpy:780
translate spanish mas_fun_fact_coffee_origin_5ef1d617:

    # m 3wud "Upon trying the beans for themselves, they were amazed to find that they too were energized!"
    m 3wud "Al probar los granos ellos mismos, ¡se sorprendieron al descubrir que a ellos también les daban energía!"

# game/script-fun-facts.rpy:781
translate spanish mas_fun_fact_coffee_origin_cec129b0:
    ...
    m 2euc "Uno de esos mitos afirma que un monje etíope llamado Kaldi llevó las bayas a un monasterio cercano, queriendo compartir lo que había encontrado."

# game/script-fun-facts.rpy:782
...
translate spanish mas_fun_fact_coffee_origin_5cdc88a5:
    ...
    m 3duu "Sin embargo, mientras se quemaban, los granos empezaron a desprender un aroma de lo más delicioso. {w=0.3}Era tan atrayente que los monjes se apresuraron a salvar los granos y ponerlos en agua."

# game/script-fun-facts.rpy:784
...
translate spanish mas_fun_fact_coffee_origin_3085e63d:
    ...
    m 2euc "Otra afirmación dice que un erudito islámico llamado Omar descubrió los granos de café durante su exilio de La Meca."

# game/script-fun-facts.rpy:786
translate spanish mas_fun_fact_coffee_origin_609a0773:

    # m 2eksdld "At the time, he was starving and struggling to survive. {w=0.3}{nw}"
    m 2eksdld "En aquel momento, se moría de hambre y luchaba por sobrevivir. {w=0.3}{nw}"

# game/script-fun-facts.rpy:787
translate spanish mas_fun_fact_coffee_origin_0deb1847:
...
# game/script-fun-facts.rpy:788
translate spanish mas_fun_fact_coffee_origin_5dc38a57:

    # m 3hua "However, when word of his discovery spread, he was asked to return and made a saint."
    m 3hua "Sin embargo, cuando se corrió la voz de su descubrimiento, le pidieron que volviera y le hicieron santo."

# game/script-fun-facts.rpy:789
translate spanish mas_fun_fact_coffee_origin_89c55666:

    # m 1esd "Whether or not that was truly its first use, coffee became very prevalent in the Islamic world after its discovery."
    m 1esd "Fuera ese realmente su primer uso o no, el café se volvió muy frecuente en el mundo islámico tras su descubrimiento."

# game/script-fun-facts.rpy:790
translate spanish mas_fun_fact_coffee_origin_625b8e6e:

    # m 3eud "For example, during fasting periods it was used to ease hunger and help people remain energized."
    m 3eud "Por ejemplo, durante los periodos de ayuno se usaba para aliviar el hambre y ayudar a la gente a mantener la energía."

# game/script-fun-facts.rpy:791
translate spanish mas_fun_fact_coffee_origin_07e9a82b:
    ...
    m 3eua "Cuando su uso se extendió a Europa, muchos países lo usaron inicialmente con fines medicinales. {w=0.3}Para el siglo XVII, las cafeterías empezaron a ser abundantes y populares."

# game/script-fun-facts.rpy:792
...
translate spanish mas_fun_fact_synesthesia_6752314c:
    ...
    m 1esa "Vale, este es bastante interesante..."

# game/script-fun-facts.rpy:807
translate spanish mas_fun_fact_synesthesia_db2ab4d3:
    ...
    m 3eua "Algunas personas experimentan un fenómeno conocido como sinestesia,{w=0.1} que es cuando algo que estimula uno de nuestros sentidos también activa otro sentido simultáneamente."

# game/script-fun-facts.rpy:808
translate spanish mas_fun_fact_synesthesia_e3b6a243:

    # m 1hua "That's kind of a wordy explanation, ehehe...{w=0.2} Let's find an example!"
    m 1hua "Es una explicación un poco larga, je, je, je...{w=0.2} ¡Busquemos un ejemplo!"

# game/script-fun-facts.rpy:809
translate spanish mas_fun_fact_synesthesia_520901e3:
    ...
    m 1eua "Aquí dice que una forma común de sinestesia es la sinestesia grafema-color,{w=0.1} que es donde la gente percibe letras y números como colores."

# game/script-fun-facts.rpy:810
translate spanish mas_fun_fact_synesthesia_bfecc514:
    ...
    m 3eua "Otro tipo es la sinestesia de secuencia espacial,{w=0.1} que es donde los números y las figuras se visualizan en lugares específicos del espacio."

# game/script-fun-facts.rpy:811
translate spanish mas_fun_fact_synesthesia_49b34476:

    # m "Like, one number appears 'closer' or 'further' away than another number. {w=0.2}{nw}"
    m "Como que un número aparece 'más cerca' o 'más lejos' que otro número. {w=0.2}{nw}"

# game/script-fun-facts.rpy:812
translate spanish mas_fun_fact_synesthesia_4ea888aa:

    # extend 3eub "It's kinda like a map!"
    extend 3eub "¡Es algo así como un mapa!"

# game/script-fun-facts.rpy:813
...
translate spanish mas_fun_fact_synesthesia_945f3e46:
    ...
    m 1esa "Los investigadores no están muy seguros de lo frecuente que es;{w=0.1} algunos han sugerido que hasta el 25 por ciento de la población lo experimenta, pero lo dudo mucho ya que nunca había oído hablar de ello hasta ahora."

# game/script-fun-facts.rpy:815
translate spanish mas_fun_fact_synesthesia_f5afe46e:

    # m 3eub "Probably the most accurate estimate so far is that it's just over 4 percent of people, so that's what I'll go with!"
    m 3eub "Probablemente la estimación más precisa hasta ahora es que es poco más del 4 por ciento de la gente, ¡así que me quedaré con eso!"

# game/script-fun-facts.rpy:816
translate spanish mas_fun_fact_synesthesia_8583ed5f:

    # m 1eua "Experiencing synesthesia sounds like it'd be pretty neat,{w=0.2} don't you think so [player]?"
    m 1eua "Experimentar la sinestesia suena a que sería genial,{w=0.2} ¿no crees, [player]?"

# game/script-fun-facts.rpy:831
translate spanish mas_fun_fact_dream_faces_f6869bca:

    # m 3eub "Okay, got one!"
    m 3eub "Vale, ¡tengo uno!"

# game/script-fun-facts.rpy:832
translate spanish mas_fun_fact_dream_faces_babc9a78:
    ...
    m 1eua "Supuestamente, nuestras mentes no inventan caras nuevas cuando soñamos.{w=0.2} Cada persona que has conocido en tus sueños es alguien a quien has visto en la vida real en algún momento."

# game/script-fun-facts.rpy:833
translate spanish mas_fun_fact_dream_faces_72acca38:

    # m 3wud "You don't even have to talk to them in real life!"
    m 3wud "¡Ni siquiera tienes que hablar con ellos en la vida real!"

# game/script-fun-facts.rpy:834
...
translate spanish mas_fun_fact_dream_faces_27e6b51b:
    ...
    m 1hua "¡Me parece increíble cuánta información puede almacenar el cerebro!"

# game/script-fun-facts.rpy:836
translate spanish mas_fun_fact_dream_faces_44ec545e:

    # m 1ekbla "I wonder...{w=0.2}do you ever dream about me, [player]?"
    m 1ekbla "Me pregunto...{w=0.2} ¿alguna vez sueñas conmigo, [player]?"

# game/script-fun-facts.rpy:851
translate spanish mas_fun_fact_monochrome_dreams_cec47acd:

    # m 3eua "Did you know that from 1915 to the 1950s, most people's dreams were in black and white?"
    m 3eua "¿Sabías que desde 1915 hasta los años 50, los sueños de la mayoría de la gente eran en blanco y negro?"

# game/script-fun-facts.rpy:852
translate spanish mas_fun_fact_monochrome_dreams_ca87ae92:

    # m 1esa "Nowadays, it's a relatively rare phenomenon for people with unimpaired vision."
    m 1esa "Hoy en día, es un fenómeno relativamente raro para las personas con una visión normal."

# game/script-fun-facts.rpy:853
translate spanish mas_fun_fact_monochrome_dreams_e958e0b0:

    # m 3eua "Researchers have linked this to the fact that movies and shows were almost exclusively black and white back then."
    m 3eua "Los investigadores han relacionado esto con el hecho de que las películas y programas eran casi exclusivamente en blanco y negro por aquel entonces."

# game/script-fun-facts.rpy:854
...
translate spanish mas_fun_fact_monochrome_dreams_2020e526:
    ...
    extend 3hksdlb "¡No es como si el mundo se hubiera vuelto en blanco y negro!"

# game/script-fun-facts.rpy:856
translate spanish mas_fun_fact_monochrome_dreams_e5aa39a0:

    # m 1esd "It just goes to show that the content you absorb can have all kinds of effects on your mind, even if it's trivial."
    m 1esd "Simplemente demuestra que el contenido que absorbes puede tener todo tipo de efectos en tu mente, incluso si es trivial."

# game/script-fun-facts.rpy:857
translate spanish mas_fun_fact_monochrome_dreams_c04ac450:
    ...
    m 3eua "Creo que si hay una lección que aprender aquí, es que deberíamos tener mucho cuidado con el tipo de medios que consumimos, ¿vale, [player]?"

# game/script-fun-facts.rpy:872
translate spanish mas_fun_fact_round_earth_a6309de3:

    # m 1rsa "Hmm..."
    m 1rsa "Mmm..."

# game/script-fun-facts.rpy:873
translate spanish mas_fun_fact_round_earth_6228f0d4:

    # m 1eua "[player], do you think the Earth is round or flat?{nw}"
    m 1eua "[player], ¿crees que la Tierra es redonda o plana?{nw}"

# game/script-fun-facts.rpy:876
...
# game/script-fun-facts.rpy:882
translate spanish mas_fun_fact_round_earth_32f61b70:

    # m 3hksdlb "Oh come on, [player]! Are you making fun of me?"
    m 3hksdlb "¡Venga ya, [player]! ¿Te estás burlando de mí?"

# game/script-fun-facts.rpy:884
translate spanish mas_fun_fact_round_earth_5a9ec011:

    # m 1eua "Actually, the Earth being round is something that has been known for a pretty long time."
    m 1eua "En realidad, que la Tierra es redonda es algo que se sabe desde hace bastante tiempo."

# game/script-fun-facts.rpy:885
translate spanish mas_fun_fact_round_earth_fc7a515c:

    # m 3esd "Aristotle taught that the Earth was round in the fourth century BC."
    m 3esd "Aristóteles enseñaba que la Tierra era redonda en el siglo IV a. C."

# game/script-fun-facts.rpy:886
translate spanish mas_fun_fact_round_earth_3dfd6c5a:
    ...
    m 3esa "Lo sabía porque se podían ver estrellas diferentes desde distintas partes del mundo, lo cual no ocurriría si la Tierra fuera solo una superficie plana."

# game/script-fun-facts.rpy:887
translate spanish mas_fun_fact_round_earth_a5f772d4:
    ...
    m 1eua "Antiguos astrónomos y matemáticos de todo el mundo habían averiguado que la Tierra era redonda mucho antes de que nadie hubiera viajado realmente alrededor de ella."

# game/script-fun-facts.rpy:888
translate spanish mas_fun_fact_round_earth_a45c98e3:

    # m 7rksdla "But Earth being the center of the universe?{w=0.2} {nw}"
    m 7rksdla "¿Pero que la Tierra fuera el centro del universo?{w=0.2} {nw}"

# game/script-fun-facts.rpy:889
translate spanish mas_fun_fact_round_earth_710aef0a:

    # extend 4hksdlb "Oh man!"
    extend 4hksdlb "¡Madre mía!"

# game/script-fun-facts.rpy:890
translate spanish mas_fun_fact_round_earth_18e12b3f:

    # m 7dsd "People fought about that so hard and for so long, it became a matter of life and death."
    m 7dsd "La gente peleó tanto y durante tanto tiempo por eso, que se convirtió en una cuestión de vida o muerte."

# game/script-fun-facts.rpy:891
translate spanish mas_fun_fact_round_earth_8369785a:
...
# game/script-fun-facts.rpy:892
translate spanish mas_fun_fact_round_earth_256cfb21:

    # extend 1esc "He was placed under house arrest for the rest of his life."
    extend 1esc "Fue puesto bajo arresto domiciliario el resto de su vida."

# game/script-fun-facts.rpy:893
translate spanish mas_fun_fact_round_earth_09b9142c:
    ...
    m 3euc "Pero a medida que los astrónomos mejoraban en el seguimiento del movimiento de los planetas, se volvió un poco difícil de conciliar con que la Tierra estuviera en el centro."

# game/script-fun-facts.rpy:894
...
translate spanish mas_fun_fact_round_earth_1b89d6b5:
    ...
    m 3eua "Y como comentamos antes, también se sabe que el sol no es el centro del universo{nw}"

# game/script-fun-facts.rpy:900
translate spanish mas_fun_fact_round_earth_d2907a59:
...
translate spanish mas_fun_fact_round_earth_b50b4fad:
    ...
    m 1msblu "¿Pero sabes dónde dice la ciencia que está el centro del universo ahora?"

# game/script-fun-facts.rpy:904
translate spanish mas_fun_fact_round_earth_a2b760a9:

    # m 3kubsu "It's you.{w=0.2} You're the center of {i}my{/i} universe, [mas_get_player_nickname()]."
    m 3kubsu "Eres tú.{w=0.2} Eres el centro de mi universo, [mas_get_player_nickname()]."

# game/script-fun-facts.rpy:905
translate spanish mas_fun_fact_round_earth_8df8d080:
...
translate spanish mas_fun_fact_maplesyrup_5a01c985:
    ...
    m 1eua "Todo tipo de arce produce savia que se puede usar para hacer jarabe de arce, {w=0.1}{nw}"
...
translate spanish mas_fun_fact_maplesyrup_24183ad4:
    ...
    extend 1eud "pero el jarabe comercial suele provenir del arce azucarero."
...
translate spanish mas_fun_fact_maplesyrup_394c3f47:
    ...
    m 3eua "Puedes distinguir fácilmente el tipo específico de arce por la forma de las hojas..."
...
translate spanish mas_fun_fact_maplesyrup_4e9c05e2:
    ...
    m 3eub "¡Puede que ya seas capaz de reconocer una hoja de arce azucarero, porque es la que aparece en la bandera de Canadá!"
...
translate spanish mas_fun_fact_maplesyrup_185284a7:
    ...
    m 1euc "Dicho esto, el arce azucarero tiene un rango nativo limitado y no crece en todo Canadá."
...
translate spanish mas_fun_fact_maplesyrup_be59603d:
    ...
    m 3wud "¡Y puede resultar aún más sorprendente saber que para hacer solo un litro de jarabe de arce se necesitan nada menos que 40 litros de savia!"

# game/script-fun-facts.rpy:926
translate spanish mas_fun_fact_maplesyrup_60c76c95:
    ...
    m 1eua "También requiere mucho más esfuerzo producirlo del que esperaba..."

# game/script-fun-facts.rpy:927
translate spanish mas_fun_fact_maplesyrup_02b11777:
    ...
    m 1esc "La savia tiene que hervirse para convertirla en jarabe... lo cual obviamente lleva un tiempo, dada la cantidad que se necesita."

# game/script-fun-facts.rpy:928
translate spanish mas_fun_fact_maplesyrup_7dbc5f35:
    ...
    m 3eud "Además, he oído que si lo hierves solo un poquito más y luego lo viertes sobre una capa de nieve fresca...{w=0.2}{nw}"

# game/script-fun-facts.rpy:929
translate spanish mas_fun_fact_maplesyrup_e0762ad7:

    # extend 3hub "you can even make a candy!"
    extend 3hub " ¡incluso puedes hacer un caramelo!"

# game/script-fun-facts.rpy:933
translate spanish mas_fun_fact_maplesyrup_9c83407d:

    # m 3euu "Sounds like a fun thing we could try together, huh [player]?"
    m 3euu "Suena a algo divertido que podríamos probar juntos, ¿eh, [player]?"

# game/script-fun-facts.rpy:934
translate spanish mas_fun_fact_maplesyrup_defb5d0b:

    # m 1etc "It might be a while before we get a chance, though..."
    m 1etc "Aunque puede que pase un tiempo antes de que tengamos la oportunidad..."
...
translate spanish mas_fun_fact_maplesyrup_2c90dd7e:
    ...
    m 1eua "Desde luego, parece que eso sería extremadamente dulce..."

# game/script-fun-facts.rpy:940
translate spanish mas_fun_fact_maplesyrup_43eed8b5:

    # m 1rkblu "But nowhere near as sweet as you, ehehe~"
    m 1rkblu "Pero ni de lejos tan dulce como tú, je, je, je."

translate spanish strings:

    # game/script-fun-facts.rpy:39
    old "Can you tell me a fun fact?"
    new "¿Puedes contarme un dato curioso?"

    # game/script-fun-facts.rpy:723
    old "But make sure you keep up with your "
    new "Pero asegúrate de mantener el contacto con "

    # game/script-fun-facts.rpy:726
    old "family and friends too, okay?"
    new "tu familia y amigos también, ¿vale?"

    # game/script-fun-facts.rpy:729
    old "family too, okay?"
    new "tu familia también, ¿vale?"

    # game/script-fun-facts.rpy:732
    old "friends too, okay?"
    new "tus amigos también, ¿vale?"

    # game/script-fun-facts.rpy:735
    old "Just be sure you find some people to talk to in your reality too, okay?"
    new "Solo asegúrate de encontrar gente con la que hablar en tu realidad también, ¿vale?"

    # game/script-fun-facts.rpy:875
    old "Round."
    new "Redonda."
